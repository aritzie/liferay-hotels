...
/**
 * Provides the remote service interface for Hotel. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see HotelServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface HotelService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.hiberus.hotels.service.impl.HotelServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hotel remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HotelServiceUtil} if injection and service tracking are not available.
	 */
