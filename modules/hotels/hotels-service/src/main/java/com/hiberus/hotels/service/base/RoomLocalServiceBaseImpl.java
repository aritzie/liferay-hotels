...
import com.hiberus.hotels.service.RoomLocalService;
import com.hiberus.hotels.service.RoomLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hiberus.hotels.service.impl.RoomLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.hiberus.hotels.service.impl.RoomLocalServiceImpl
 * @generated
 */
public abstract class RoomLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RoomLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RoomLocalServiceUtil</code>.
	 */
	...
	public List<Room> getRoomsByUuidAndCompanyId(
		...
		return roomPersistence.findByUuid_C(
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(roomLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		RoomLocalService roomLocalService) {

		try {
			Field field = RoomLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, roomLocalService);
		}
